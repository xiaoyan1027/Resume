...
<header>
    ...
    <ul class="rt_nav">
        <li><a href="?r=index/fabiao" target="_blank" class="website_icon">站点首页</a></li>
        <li><a href="#" class="admin_icon">DeathGhost</a></li>
        <li><a href="#" class="set_icon">账号设置</a></li>
        <li><a href="?r=login/del_session" class="quit_icon">安全退出</a></li>
    </ul>
</header>
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <!--结束：弹出框效果-->
        <form action="?r=index/fabiao_add" method="post">
        <section>
            <h2><strong style="color:grey;">招聘职位添加</strong></h2>
            <ul class="ulColumn2">
                <li>
                    <span class="item_name" style="width:120px;">职位名称：</span>
                    <input type="text" name="name" class="textbox textbox_295" placeholder="请输入职位名称"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">职位类型：</span>
                    <input type="text" name="type" class="textbox textbox_295" placeholder="请输入职位类型"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">工作地址：</span>
                    <input type="text" name="address" class="textbox textbox_295" placeholder="请输入工作地址"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">薪资范围：</span>
                    <input type="text" name="monery" class="textbox textbox_295" placeholder="请输入工作地址"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">学历要求：</span>
                    <input type="text" name="xueli" class="textbox textbox_295" placeholder="请输入工作地址"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">福利：</span>
                    <input type="text" name="fuli" class="textbox textbox_295" placeholder="请输入福利"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">公司介绍：</span>
                    <textarea placeholder="公司介绍" name="content" class="textarea" style="width:500px;height:100px;"></textarea>
                </li>

                <li>
                    <span class="item_name" style="width:120px;"></span>
                    <input type="submit" value="添加招聘职位" class="link_btn"/>
                </li>
            </ul>
        </section>
        </form>