...
<div class="login_wrapper">
    ...
    <div class="login_box">
        <form id="loginForm" action="?r=register/add" method="post">
            ...
            <input type="text" id="email" name="username" tabindex="1" placeholder="请输入用户名" />
            ...
            <input name="_csrf-frontend" value="" type="hidden">
        ...
        $("#loginForm").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    ...
                    if(result.success){
                        alert('注册成功！');window.location.href='?r=register/show';
                    }else{
