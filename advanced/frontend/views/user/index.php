...
<head>
    ...
    <script type="text/javascript" src="jobs/js/base_new.js"></scjobs/ript>
        ...
        <div class="dl_bigwrap dl_gray_bg clearfix">
            <div class="leftmenu">
                ...
                <ul class="dl_menulist clearfix">
                    ...
                    <li> <a href="member_resume.html" class="profile">我的简历</a> </li>
...
<script language="javascript" type="text/javascript" src="jobs/js/json2.js"></script>
