                            ...
                            <div class="dl_myleftform">
                                ...
                                <div class="form_container" id="RecruitmentPortal.Objective">
                                    ...
                                    <div class="form_part">
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li><label>现从事行业：</label> <input class="mul_input industry" name="RecruitmentPortalObjective_EngagedIndustry_txt" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212_txt" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                ...
                                                <li><label>现工作城市：</label> <input type="text" readonly="true" displayname="现工作城市" constname="Areas" value="" class="Ajson ConstDictSingleSelect" id="RecruitmentPortalObjective_CurrWorkCity_Id" /> <input type="hidden" value="" name="RecruitmentPortalObjective_CurrWorkCity" id="RecruitmentPortalObjective_CurrWorkCity" class="ResidenceState" /> </li>
                                                ...
                                                <li><label class="current label_required">期望从事行业：</label> <input class="mul_input industry" name="RecruitmentPortalObjective_ExpectIndustry_txt" id="e5688d4a-bad3-48fb-842e-0ae7df7036d51212_txt" value="" /> <input type="hidden" id="e5688d4a-bad3-48fb-842e-0ae7df7036d51212" name="RecruitmentPortalObjective_ExpectIndustry" class="{required:true,messages:&quot;请填写期望从事行业&quot;}" /> </li>
                                                <li><label class="current">期望从事职业：</label> <input type="text" readonly="true" displayname="期望从事职业" constname="JobCategory" value="" class="Ajson ConstDictSingleSelect" id="RecruitmentPortalObjective_ExpectJobCategory_Id" /> <input class="ResidenceState" type="hidden" value="" name="RecruitmentPortalObjective_ExpectJobCategory" id="RecruitmentPortalObjective_ExpectJobCategory" /> </li>
                                                <li><label class="current label_required">期望工作城市：</label> <input name="RecruitmentPortalObjective_ExpectWorkCity_txt" id="bdb0be18-1b30-4001-817e-34807ab4d94b1212_txt" value="" /> <input type="hidden" value="" id="bdb0be18-1b30-4001-817e-34807ab4d94b1212" name="RecruitmentPortalObjective_ExpectWorkCity" class="{required:true,messages:&quot;请填写期望工作城市&quot;}" /> </li>
