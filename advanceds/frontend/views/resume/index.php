                ...
                <tr>
                    <td align="center">
                        <ul class="dl_picliu">
                           ...
                           <li class="greyprofile" onclick="BSGlobal.navigate(1);" style="cursor: pointer;"><a href="javascript:void(0);" onclick="BSGlobal.navigate(1);"><span class="dl_grey2"> <a href="?r=resume/two">2个人履历</span></a></a></li>
                            <li class="greyarrow"></li>
        ...
        <div>
            ...
            <div class="dl_bacwrap dl_new_error_wrap">
                <div class="mainwrap">
                    ...
                    <form method="post" action="?r=resume/add"  enctype="multipart/form-data">
                        <div class="clearfix">
                                ...
                                <div class="form_container" id="RecruitmentPortal.PersonProfile">
                                    ...
                                    <div class="form_part">
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li><label class="current label_required" >姓名：</label> <input name="User_name" class="{required:true,messages:&quot;请填写姓名&quot;} mul_input"  id="4c037148-140a-4c2b-b87a-b97609215d7011" value="" /> <span class="desc"></span> </li>
                                                <li><label class="current label_required">性别：</label>
                                                    <div class="radio_list">
                                                        <input type="radio" name="User_sex" value="0"  checked="checked"/>
                                                        <label class="radio_label">男</label>
                                                        <input type="radio" name="User_sex" value="1" />
                                                        <label class="radio_label">女</label>
                                                    </div> </li>
                                                <li><label class="current label_required">出生日期：</label> <input class="mul_input Wdate" name="User_born" id="436ab7a4-67a1-4819-a238-d5d34eb0717611" value="" /> <span class="desc"></span> </li>
                                                <li><label class="current label_required">邮箱：</label> <input class="{required:true,messages:&quot;请填写邮箱&quot;} mul_input" name="User_email" id="67a5c587-4f90-4ae7-819f-eb3dba9ea39911" value="" /> <span class="desc"></span> </li>
                                                <li><label class="current label_required">手机号：</label> <input class="{required:true,messages:'请填写手机号'} mul_input " name="User_phone" id="acb9b67f-9643-41fb-a7fe-5ff8d742ccdf11" value="" /> </li>
                                            </ul>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                            ...
                            <div class="dl_myleftform">
                                ...
                                <div class="form_container" id="RecruitmentPortal.Objective">
                                    ...
                                    <div class="form_part">
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li><label>现从事行业：</label> <input class="mul_input industry" name="Industry_now" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>现从事职业：</label> <input class="mul_input industry" name="Occupation_now" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>现工作城市：</label> <input class="mul_input industry" name="City_now" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>现月薪(税前)：</label> <select name="Money_now" id="RecruitmentPortalObjective_CurrSalary" class="mul_select"> <option value="">请选择</option> <option value="1">1000以下</option> <option value="2">1000～2000</option> <option value="3">2001～4000</option> <option value="4">4001～6000</option> <option value="5">6001～8000</option> <option value="6">8001～10000</option> <option value="7">10001～15000</option> <option value="8">15001～25000</option> <option value="9">25000以上</option> <option value="10">面议</option> </select> </li>
                                                <li><label>期望从事行业：</label> <input class="mul_input industry" name="Industry_hope" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>期望从事职业：</label> <input class="mul_input industry" name="Occupation_hope" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>期望工作城市：</label> <input class="mul_input industry" name="City_hope" value="" /> <input type="hidden" value="" id="ef3f9faf-97c6-432b-9c6b-0b0b66c5c4271212" name="RecruitmentPortalObjective_EngagedIndustry" /> </li>
                                                <li><label>期望月薪(税前)：</label> <select name="Money_hope" id="RecruitmentPortalObjective_ExpectSalary" class="mul_select"> <option value="">请选择</option> <option value="1">1000以下</option> <option value="2">1000～2000</option> <option value="3">2001～4000</option> <option value="4">4001～6000</option> <option value="5">6001～8000</option> <option value="6">8001～10000</option> <option value="7">10001～15000</option> <option value="8">15001～25000</option> <option value="9">25000以上</option> <option value="10">面议</option> </select> </li>
                                                <li><label>到岗时间：</label> <select name="Go_time" id="RecruitmentPortalObjective_EntrantDate" class="mul_select"> <option value="">请选择</option> <option value="1">一周内</option> <option value="2">一个月内</option> <option value="3">三个月内</option> <option value="4">三个月以上</option> <option value="5">面议</option> </select> </li>
                                            </ul>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
...
<!--                        <a name="btnSave" href="?r=resume/add" class="dl_btn_grey1"><span>保存并下一步</span></a>-->
